        ...
        @forelse($contacts as $contact)
          <tr>
            ...
            <td class="d-flex justify-content-center gap-2">
              <a href="javascript:void(0)" class="btn btn-sm btn-info viewContactBtn"
              ...
              <form class="deleteContactForm" action="{{ route('admin.contactUs.destroy', $contact->id) }}" method="POST">
                @csrf
                @method('DELETE')
              ...
              <a href="javascript:void(0)" class="btn btn-sm btn-primary replyContactBtn"
                 data-id="{{ $contact->id }}" data-email="{{ $contact->email }}"
