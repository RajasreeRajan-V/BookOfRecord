          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center justify-content-lg-end mb-0">
              ...
              <li class="breadcrumb-item"><a class="text-primary"
                  href="{{ route('category.record', $record->category->id) }}">{{ $record->category->name}}</a></li>
      ...
      <div class="row align-items-center gy-4 mt-4">
        ...
        <div class="col-12 col-md-6 wow fadeIn" data-wow-delay="0.1s">
          <div class="choose-card single-gallery-card"
            ...
            <img src="{{ asset('storage/' . $record->image) }}" style="width: 100%; height: 350px; object-fit: cover;">
          </div>
        </div>
